...
export default function Education() {
  return (
    <SectionWrapper id="education" className="bg-white dark:bg-[#0f1629]/50">
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        {education.map((edu) => (
          <motion.div key={edu.id} variants={fadeUp}>
            <div className="card p-6 flex gap-5 items-start hover:border-primary-400/50 dark:hover:border-primary-600/50 transition-colors">
